...
<body style="background-color: #FAD7A0">
	<button style="background-color:#FAD7A0"><a href="admin1st.html" style="color:">Back</a></button>
	...
	<table align="center">
		...
		$query="select * from schedules s,played_in p where s.team1=p.team1 order by s.date";

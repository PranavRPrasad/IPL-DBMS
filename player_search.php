...
<body style="background-color: #FAD7A0"><button style="background-color:#814111 "><a href="admin1st.html" style="color: white">Back</a></button><br><br>
...
<?php
    ...
    if(mysqli_num_rows($res)>0){
        ...
        echo " <h1><p align="."center".">".$row["playername"]."<p></h1><table width="."100%"." height="."400px"."><tr><th height="."100%"."><img src=".$row["image"]." width="."400px"."></th><th><table width="."100%".">
